...
using namespace std;
/*
Generar en un arreglo que le llama base 5 numeros entre 1 y 10, igual en el otro arreglo que se llama expo.
usar un procedimiento.
luego determinar la potencia elevando la base al expo y copiarla a otro arreglo.
*/
int const n=5;
int base[n];
int expo[n];
